...
#ifndef __ZIRCON_BOOT_IMAGE_H_
#define __ZIRCON_BOOT_IMAGE_H_
...
#define ZBI_CONTAINER_HEADER(length)                               \
	{                                                          \
		ZBI_TYPE_CONTAINER, (length), ZBI_CONTAINER_MAGIC, \
			ZBI_FLAGS_VERSION, 0, 0, ZBI_ITEM_MAGIC,   \
			ZBI_ITEM_NO_CRC32,                         \
	}
#endif
...
#define ZBI_IS_KERNEL_BOOTITEM(x) \
	(((x)&ZBI_TYPE_KERNEL_MASK) == ZBI_TYPE_KERNEL_PREFIX)
...
#define ZIRCON_VENDOR_GUID                                             \
	{                                                              \
		...
		{                                                      \
			0xa0, 0xc8, 0x6c, 0x20, 0x72, 0xd0, 0x84, 0x4c \
		}                                                      \
	}
